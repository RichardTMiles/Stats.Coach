...
class Creation_Logs extends Rest implements iRestfulReferences
{
    ...
    */
    ...
    public static function Post(array $argv, string $dependantEntityId = null): bool
    {
        ...
        $sql = 'INSERT INTO StatsCoach.creation_logs (uuid, resource_type, resource_uuid) VALUES ( UNHEX(:uuid), :resource_type, UNHEX(:resource_uuid))';
    ...
    public static function buildSelectQuery(string $primary = null, array $argv, PDO $pdo = null, bool $noHEX = false) : string 
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM StatsCoach.creation_logs ' . $join;
    ...
    */
    public static function Put(array &$return,  array $argv) : bool
    {
        ...
        $sql = 'UPDATE StatsCoach.creation_logs ';
    ...
    */
    public static function Delete(array &$remove, array $argv) : bool
    {
        ...
        $sql = 'DELETE FROM StatsCoach.creation_logs ';
