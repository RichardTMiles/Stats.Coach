...
class Carbon_Users extends Rest implements iRest
{
    ...
    public const USER_GOOGLE_ID = 'carbon_users.user_google_id'; 
    ...
    */
    ...
    public static function Post(array $argv, string $dependantEntityId = null)
    {
        ...
        $user_google_id =  $argv['carbon_users.user_google_id'] ?? null;
    ...
    public static function buildSelectQuery(string $primary = null, array $argv, PDO $pdo = null, bool $noHEX = false) : string 
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM StatsCoach.carbon_users ' . $join;
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        if (array_key_exists('carbon_users.user_google_id', $argv)) {
        ...
        if (array_key_exists('carbon_users.user_google_id', $argv)) {
            $user_google_id = $argv['carbon_users.user_google_id'];
            $stmt->bindParam(':user_google_id',$user_google_id, 2, 225);
        }
    ...
    */
    public static function Delete(array &$remove, string $primary = null, array $argv) : bool
    {
        ...
        $sql = 'DELETE c FROM StatsCoach.carbons c 
                JOIN StatsCoach.carbon_users on c.entity_pk = carbon_users.user_id';
