...
class Carbon_User_Notifications extends Rest implements iRest
{
    
    public const TABLE_NAME = 'carbon_user_notifications';
    public const NOTIFICATION_ID = 'carbon_user_notifications.notification_id'; 
    public const TO_USER_ID = 'carbon_user_notifications.to_user_id'; 
    public const NOTIFICATION_DATA = 'carbon_user_notifications.notification_data'; 

    public const PRIMARY = [
        'carbon_user_notifications.notification_id',
    ];

    public const COLUMNS = [
        'carbon_user_notifications.notification_id' => 'notification_id','carbon_user_notifications.to_user_id' => 'to_user_id','carbon_user_notifications.notification_data' => 'notification_data',
    ];

    public const PDO_VALIDATION = [
        'carbon_user_notifications.notification_id' => ['binary', '2', '16'],'carbon_user_notifications.to_user_id' => ['binary', '2', '16'],'carbon_user_notifications.notification_data' => ['json', '2', ''],
    ];
    ...
    {
        $inject = ':injection' . count(self::$injection) . 'carbon_user_notifications';
    ...
    */
    public static function Get(array &$return, string $primary = null, array $argv): bool
    {
        ...
        */
        ...
        if (array_key_exists('carbon_user_notifications.notification_data', $return)) {
    ...
    public static function Post(array $argv, string $dependantEntityId = null)
    {
        ...
        $notification_id = $id = $argv['carbon_user_notifications.notification_id'] ?? self::beginTransaction('carbon_user_notifications', $dependantEntityId);
        $stmt->bindParam(':notification_id',$notification_id, 2, 16);
    
        $to_user_id =  $argv['carbon_user_notifications.to_user_id'] ?? null;
        $stmt->bindParam(':to_user_id',$to_user_id, 2, 16);
    
        $stmt->bindValue(':notification_data',json_encode($argv['carbon_user_notifications.notification_data']), 2);
    ...
    public static function validateSelectColumn($column) : bool {
        return (bool) preg_match('#(((((hex|argv|count|sum|min|max) *\(+ *)+)|(distinct|\*|\+|-|/| |carbon_user_notifications\.notification_id|carbon_user_notifications\.to_user_id|carbon_user_notifications\.notification_data))+\)*)+ *(as [a-z]+)?#i', $column);
    }
    ...
    public static function buildSelectQuery(string $primary = null, array $argv, PDO $pdo = null, bool $noHEX = false) : string 
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM StatsCoach.carbon_user_notifications ' . $join;
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        if (array_key_exists('carbon_user_notifications.notification_id', $argv)) {
            $set .= 'notification_id=UNHEX(:notification_id),';
        }
        if (array_key_exists('carbon_user_notifications.to_user_id', $argv)) {
            $set .= 'to_user_id=UNHEX(:to_user_id),';
        }
        if (array_key_exists('carbon_user_notifications.notification_data', $argv)) {
        ...
        if (array_key_exists('carbon_user_notifications.notification_id', $argv)) {
            $notification_id = $argv['carbon_user_notifications.notification_id'];
            $stmt->bindParam(':notification_id',$notification_id, 2, 16);
        }
        if (array_key_exists('carbon_user_notifications.to_user_id', $argv)) {
            $to_user_id = $argv['carbon_user_notifications.to_user_id'];
            $stmt->bindParam(':to_user_id',$to_user_id, 2, 16);
        }
        if (array_key_exists('carbon_user_notifications.notification_data', $argv)) {
            $stmt->bindValue(':notification_data',json_encode($argv['carbon_user_notifications.notification_data']), 2);
        ...
        $argv = array_combine(
            array_map(
                static function($k) { return str_replace('carbon_user_notifications.', '', $k); },
                array_keys($argv)
            ),
            array_values($argv)
        );
    ...
    */
    public static function Delete(array &$remove, string $primary = null, array $argv) : bool
    {
        ...
        $sql = 'DELETE c FROM StatsCoach.carbons c 
                JOIN StatsCoach.carbon_user_notifications on c.entity_pk = carbon_user_notifications.notification_id';
