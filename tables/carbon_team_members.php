...
class carbon_team_members extends Database implements iRest
{
    ...
    public const COLUMNS = [
        'member_id' => [ 'binary', '2', '16' ],'team_id' => [ 'binary', '2', '16' ],'user_id' => [ 'binary', '2', '16' ],'accepted' => [ 'tinyint', '0', '1' ],
    ];
    ...
    public static function Get(array &$return, string $primary = null, array $argv) : bool
    {
        ...
        foreach($get as $key => $column){
            ...
            if ($columnExists && self::COLUMNS[$column][0] === 'binary') {
                ...
                if (!preg_match('#(((((hex|argv|count|sum|min|max) *\(+ *)+)|(distinct|\*|\+|\-|\/| |member_id|team_id|user_id|accepted))+\)*)+ *(as [a-z]+)?#i', $column)) {
                    return false;
                }
                $sql .= $column;
                $aggregate = true;
        ...
        $sql = 'SELECT ' .  $sql . ' FROM StatsCoach.carbon_team_members';
