            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle"
                         src="<?= SITE_ROOT . $this->user_profile_pic ?>" alt="User profile picture">
                    <h3 class="profile-username text-center"><?= $this->user_first_name ?> <?= $this->user_last_name ?></h3>
        ...
        <div class="col-md-9 col-sm-12 col-xs-12">
            <div class="box box-info">
                ...
                <div class="box-footer clearfix">
                    <a href="javascript::;" class="btn btn-sm btn-info btn-flat pull-left">Post New Round</a>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="settings">
                        <!-- Form Start -->
                        <form class="form-horizontal" action="<?= SITE_ROOT ?>Users/Profile/" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <img class="profile-user-img img-responsive img-circle" src="<?= SITE_ROOT . $this->user_profile_pic ?>"
