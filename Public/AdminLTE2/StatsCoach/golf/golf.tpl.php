<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><?= $this->user_first_name . " " . $this->user_last_name ?></li>
...
<section class="content">
    ...
    <div class="box box-widget widget-user">
        ...
        <div class="widget-user-header bg-black" style="background: url('<?= TEMPLATE_PATH ?>dist/img/photo1.png') center center;">
            <h3 class="widget-user-username"><?= $this->user_first_name . " " . $this->user_last_name ?></h3>
            <h5 class="widget-user-desc">Team</h5>
        </div>
        <div class="widget-user-image">
            <img class="img-circle" src="<?= SITE_ROOT . $this->user_profile_pic ?>" alt="User Avatar">
        </div>
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12" style="background-color: #4b646f;">
            <div class="info-box">
