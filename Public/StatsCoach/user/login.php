            ...
            <a href="<?= SITE_ROOT . 'recover/'; ?>">Forgot password
                ...
                <?php else: ?>
                    ...
                    <div class="lockscreen-wrapper">
                        <!-- User name -->
                        <div class="lockscreen-name" style="text-align: center"><b><?=$this->FullName?></b></div>
                        ...
                        <div class="lockscreen-item">
                            ...
                            <form class="lockscreen-credentials" action="<?= SITE_ROOT ?>login/" method="post">
                        ...
                        <div class="text-center">
                            <a href="<?=SITE_ROOT . 'login/clear/'?>">Or sign in as a different user</a>
                        </div>
