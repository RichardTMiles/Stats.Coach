...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="preload" href="<?=$this->versionControl('plugins/fontAwesome/font-awesome.min.css');?>" as="style" onload="this.rel='stylesheet'">
    <!-- Ionicons -->
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="social-auth-links text-center">
            <p>- OR -</p>
            <a href="<?=$this->faceBookLoginUrl()?>" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using Facebook</a>
