<!-- Content Header (Page header) -->
    ...
    <small>Stats.Coach</small>
      ...
      <ol class="breadcrumb">
        <li><a href="<?=SITE_ROOT?>"><i class="fa fa-dashboard"></i> Home</a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Last updated:  <?=date( 'm/d/Y', filemtime(__FILE__))?></h3>
        ...
        <div class="box-body">
            ...
            This Privacy Policy is effective as of 5/1/2015 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.
