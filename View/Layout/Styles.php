<noscript id="deferred-styles">
    ...
    <!-- Bootstrap 3.3.6 -->
    <link rel="stylesheet" type="text/css" href="<?= SITE . TEMPLATE . "bower_components/bootstrap/dist/css/bootstrap.min.css" ?>">
    <!-- Theme style -->
    ...
    <!-- datepicker -->
    <link rel="stylesheet" type="text/css" href="<?= SITE . TEMPLATE . "bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.css" ?>">
    <!-- date-range-picker -->
    <link rel="stylesheet" type="text/css" href="<?= SITE . TEMPLATE . "bower_components/bootstrap-daterangepicker/daterangepicker.css" ?>">
