...
class Photos extends Entities implements iEntity
{
    ...
    static function add($object, $id, $array)
    {
        ...
        $sql = 'INSERT INTO StatsCoach.entity_photos (parent_id, photo_id, user_id, photo_path, photo_description) VALUES (:parent_id, :photo_id, :user_id, :photo_path, :photo_description)';
