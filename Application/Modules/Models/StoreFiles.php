...
class StoreFiles
{
    ...
    public function __construct($input = 'FileToUpload', $loc, $multiple = false)
    {
        $this->FilePath = 'false';
        (!$multiple) ? $this->singleFile( $input, $loc ) : $this->multipleFiles();
    }
    ...
    private function singleFile($input, $loc)
    {
        try {
            ...
            do {
                ...
                $targetPath = $loc . $_SESSION['id'] . '_' . time() . '_' . $count . '.' . $ext;
